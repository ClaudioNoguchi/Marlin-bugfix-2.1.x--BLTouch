...
#define STRING_CONFIG_H_AUTHOR "(Claudio Noguchi Ender-3)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3BLT Extreme"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.5, -7, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define XY_PROBE_FEEDRATE    (200*60) // 133*60(mm/min)

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (16*60) // 4*60(mm/min)
...
//#define MANUAL_X_HOME_POS 117
//#define MANUAL_Y_HOME_POS 117
